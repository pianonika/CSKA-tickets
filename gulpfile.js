...
function getComponentsFiles() {
  ...
  // Если хочется иметь в конкатенируемом JS ещё какие-то файлы, пишите это здесь
  if(fileExistAndHasContent(dirs.source + '/js/jquery.magnific-popup.min.js')) {
    //сomponentsFilesList.js.unshift(dirs.source + '/js/file_name.js'); // добавляем в начало
    //или
    сomponentsFilesList.js.unshift(dirs.source + '/js/jquery.magnific-popup.min.js'); // добавляем в конец
  }

  // Если хочется иметь в конкатенируемом JS ещё какие-то файлы, пишите это здесь
  if(fileExistAndHasContent(dirs.source + '/js/slick.min.js')) {
    сomponentsFilesList.js.unshift(dirs.source + '/js/slick.min.js'); // добавляем в конец
  }
...
if(fileExistAndHasContent(dirs.source + '/js/jquery.validate.js')) {
 ...
 if(fileExistAndHasContent(dirs.source + '/js/mediaelement-and-player.js')) {
    сomponentsFilesList.js.unshift(dirs.source + '/js/mediaelement-and-player.js'); // добавляем в начало
  }
